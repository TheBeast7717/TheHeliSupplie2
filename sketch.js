...
//chopper.collide(boxStopperBar);
	...
	if(dropBoxRightFace.isTouching(dropGroundFace)){
		Matter.Body.setStatic(dropBoxRight,true);
		
	}
	if(dropBoxLeftFace.isTouching(dropGroundFace)){
		Matter.Body.setStatic(dropBoxLeft,true);
